...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/qRazDUmlk5)
...
```sh
npx nx serve expo-mono
```

To create a production bundle:

```sh
npx nx build expo-mono
```

To see all available targets to run for a project, run:

```sh
npx nx show project expo-mono
```
